...
const handleSubmit = async () => {
  ...
  try {
    const res = await fetch('https://vfyjftdtypyarntxknio.supabase.co/auth/v1/recover', {
      method: 'POST',
      headers: {
        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZmeWpmdGR0eXB5YXJudHhrbmlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE4MzAyNTYsImV4cCI6MjA1NzQwNjI1Nn0.WTWuWRc31PVx7EWYxzUUpss-_A5PON-rdColLzPhDvs',
